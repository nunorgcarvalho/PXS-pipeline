...
1. `initial_setup.sh`: extracts necessary fields from phenotype file, calculates the coefficients for the PXS for the phenotype of choice, and initiates scripts that compute the PXS for each phenotype
