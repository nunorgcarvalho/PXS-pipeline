...
#SBATCH -p medium
#SBATCH --mem=125G
#SBATCH -o GWAS.PXS_death.out
#SBATCH -e GWAS.PXS_death.err
...
--phenoFile /home/nur479/group_nuno/PXS-pipeline/scratch/mortality/pheno_EC.death.txt \
--phenoCol PXS_death \
--covarFile /home/nur479/group_nuno/PXS-pipeline/scratch/mortality/pheno_EC.death.txt \
--covarCol sex \
...
--lmm \
--verboseStats \
--statsFile /home/nur479/group_nuno/PXS-pipeline/scratch/mortality/LMM.PXS_death.txt \
